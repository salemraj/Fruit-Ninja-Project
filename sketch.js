var knife,fruit;
var knifeImage , guavaImg, appleImg ,bananaImg,orangeImg, monsterImage, gameOverImage,cutting_sound,gameOver_sound,backGroundImage;
...
function setup() 
{
  ...
  //creating a start button as a sprite so that the game will start when the start button is pressed
  startButton = createSprite(290,550,120,50);
  
  //code to give colour to the start button
  startButton.shapeColor = "lime";
  
  //creating a play button as a sprite to play the game when the play button is pressed
  playButton = createSprite(290,350,90,50);
  
  //code to give colour to the play button
  playButton.shapeColor = "purple";
  
  //code to make the play button invisible
  playButton.visible = false;
  
  //creating a restart button as a sprite so that the game will restart when the restart button is pressed
  restartButton = createSprite(290,100,160,50);
...
function draw() 
{
  ...
  if(gameState == INT)
    {
      //code to make the knife invisible when the game state is in the instruction 
      knife.visible = false;
      ...
      textSize(60);
      fill("yellow");
      text("INSTRUCTION",90,100);
      
      //code to display instruction
      textSize(30);
      fill("blue");
      text("1.There is a knife in this game and you can",10,150);
      
      textSize(30);
      fill("blue");
      text("move the knife using the mouse.",40,200);
      
      textSize(30);
      fill("blue");
      text("2.If the mouse touches the fruits you will",10,250);
      
      textSize(30);
      fill("blue");
      text("earn points.",40,300);
      
      textSize(30);
      fill("blue");
      text("3.If the mouse touches the smiley balls you",10,350);
      
      textSize(30);
      fill("blue");
      text("will lose",40,400);
      
      //code to display press the start button to start the game when the game state is in the instruction
      textSize(40);
      fill("purple");
      text("Press this button to start",70,500);
      
      //code to display the text start over the start button when the game state is in the instruction
      textSize(30);
      fill("blue");
      text("Start",255,560);
  ...
  //code when the game state is in the restart
    ...
    {
      //code to make the knife invisible when the game state is in the restart 
      knife.visible = false;
      ...
      //code to reset the chopped score when the game state is in the restart
      choppedScore = 0;
    
      //code to reset the speed of the fruits and smiley balls when the game state is in the restart
      speedScore = 0;
    
      //code to display press the play button play when the game state is in the restart
      textSize(40);
      fill("orange");
      text("Press this button to play",70,300);
      ...
      //code to change the game state to play when the mouse is pressed on the play button
  ...
  if(gameState == PLAY)
    {
      ...
      //code to make the game over invisible when the game state when the game state is in the play
      gameOver.visible = false;
      
      //code to make the start button invisible when the game state when the game state is in the play
      startButton.visible = false;
      
      //code to make the play button invisible when the game state when the game state is in the play
      playButton.visible = false;

      //code to make the restart button invisible when the game state when the game state is in the play
      restartButton.visible = false;
      ...
      textSize(30);
      fill("gold");
      text("Chopping Points:" + choppedScore,180,50);
  ...
  if(gameState == END)
    {
      //code to make the knife invisible when the game state is in the end
      knife.visible = false;
      
      //code to make the game over visible when the game state is in the end
      gameOver.visible = true;
      
      //code to make the start button invisible when the game state is in the end
      startButton.visible = false;
      
      //code to make the play button invisible when the game state is in the end
      playButton.visible = false;
      
      //code to make the restart button visible when the game state is in the end
      ...
      //code to display reward for the player after he plays the game when the game state is in the end
      textSize(110);
      fill("magenta");
      text("Fabuluous!",30,340);
      
      textSize(60);
      fill("purple");
      text("You have earned",70,410);
      
      textSize(60);
      fill("red");
      text(choppedScore,140,480);
      ...
      textSize(60);
      fill("purple");
      text("by chopping",140,550);
      
      //code to display press the restart button to restart the game when the game state is in the end
      textSize(40);
      fill("blue");
      text("Press this button to restart",60,50)
      
      //code to display the text restart over the restart button when the game state is in the end
      textSize(30);
      fill("red");
      text("Restart",240,110);
  ...
  if(frameCount%120 == 0)
    {
      ...
      var smileyBall1 = createSprite(random(50,550),-100,20,20);
  ...
  if(frameCount%120 == 0)
    {
      ...
      var smileyBall2 = createSprite(random(50,550),700,20,20);
  ...
  if(frameCount%120 == 0)
    {
      ...
      var smileyBall3 = createSprite(700,random(50,550),20,20);
  ...
  if(frameCount%120 == 0)
    {
      ...
      var smileyBall4 = createSprite(-100,random(50,550),20,20);
...
function createGuavas1()
{
  ...
  var guava1 = createSprite(random(100,500),-150,20,20);
...
function createApples1()
{
  ...
  var apple1 = createSprite(random(100,500),-150,20,20);
...
function createOranges1()
{
  ...
  var orange1 = createSprite(random(100,500),-150,20,20);
...
function createGuavas2()
{
  ...
  var guava2 = createSprite(random(100,500),750,20,20);
...
function createApples2()
{
  ...
  var apple2 = createSprite(random(100,500),750,20,20);
...
function createBananas2()
{
  ...
  var banana2 = createSprite(random(100,500),750,20,20);
...
function createOranges2()
{
  ...
  var orange2 = createSprite(random(100,500),750,20,20);
...
function createGuavas3()
{
  ...
  var guava3 = createSprite(-150,random(100,500),20,20);
...
function createApples3()
{
  ...
  var apple3 = createSprite(-150,random(100,500),20,20);
...
function createBananas3()
{
  ...
  var banana3 = createSprite(-150,random(100,500),20,20);
...
function createOranges3()
{
  ...
  var orange3 = createSprite(-150,random(100,500),20,20);
...
function createGuavas4()
{
  ...
  var guava4 = createSprite(750,random(100,500),20,20);
...
function createApples4()
{
  ...
  var apple4 = createSprite(750,random(100,500),20,20);
...
function createBananas4()
{
  ...
  var banana4 = createSprite(750,random(100,500),20,20);
